...
class DataReceiptScreen extends StatefulWidget {
  ...
  const DataReceiptScreen({super.key, required this.networkImage, required this.dataPurchaseModel, required this.networkName});
        ...
        children: [
          ...
          Row(children: [
            ...
            Theme.of(context).textTheme.bodyMedium?.copyWith(
                  ...
                  child: Text(widget.dataPurchaseModel.message!.id!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                    // color: kBlack,
                    fontSize: SizeConfig.blockSizeVertical! * 1.8,
                  ),),
                ),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Description',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  ...
                  child: Text(widget.dataPurchaseModel.message!.detail!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                    // color: kBlack,
                    fontSize: SizeConfig.blockSizeVertical! * 1.8,
                  ),),
                ),

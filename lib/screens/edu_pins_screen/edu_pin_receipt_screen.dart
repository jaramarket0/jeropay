...
class EduPinReceiptScreen extends StatefulWidget {
  final String networkImage;
  final String networkName;
  // final int index;
  final EduPinPurchaseModel dataPurchaseModel;
  const EduPinReceiptScreen({super.key, required this.networkImage, required this.dataPurchaseModel, required this.networkName});

  @override
  State<EduPinReceiptScreen> createState() => _EduPinReceiptScreenState();
}

class _EduPinReceiptScreenState extends State<EduPinReceiptScreen> {
  @override
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(widget.dataPurchaseModel.message!.response!,style: 
                Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.5,
                ),textAlign: TextAlign.center,),
                Text(widget.dataPurchaseModel.message!.requestId!,style: 
                Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.5,
                ),textAlign: TextAlign.center,),
          ...
          Row(children: [
            ...
            Theme.of(context).textTheme.bodyMedium?.copyWith(
                ...
                ),),Spacer(), Text(widget.dataPurchaseModel.message!.id!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Status',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text(widget.dataPurchaseModel.message!.status!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Phone',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text(widget.dataPurchaseModel.message!.phoneNumber!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Description',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text(widget.dataPurchaseModel.message!.detail!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Amount',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text('\u20A6${widget.dataPurchaseModel.message!.amount}',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Previous Balance',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text('\u20A6${widget.dataPurchaseModel.message!.oldBalance}',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('New Balance',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text('\u20A6${widget.dataPurchaseModel.message!.newBalance}',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Transaction Date',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text(widget.dataPurchaseModel.message!.dateAndTime!.substring(0, 10),

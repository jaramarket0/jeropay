...
CableController controller = Get.put(CableController());
...
AppToast.error('Passcode does\'st match!!!');
//return;
    }
    ...
    //   SnackBar(
    //     content: Text('Transaction Authorized successfully!'),
    //     duration: Duration(seconds: 2),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      "${widget.validationModel!.message}",
                      style: Theme.of(
                        context,
                      ).textTheme.headlineSmall?.copyWith(
                        fontSize: SizeConfig.blockSizeVertical! * 2.0,

...
class CableReceiptScreen extends StatefulWidget {
  ...
  // final int index;
  final CablePurchaseModel cablePurchaseModel;
  const CableReceiptScreen({super.key, required this.networkImage, required this.cablePurchaseModel, required this.networkName});
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(widget.cablePurchaseModel.data!.response!,style: 
                Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.5,
                ),textAlign: TextAlign.center,),
                Text(widget.cablePurchaseModel.data!.requestId!,style: 
                Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.5,
                ),textAlign: TextAlign.center,),
          ...
          Row(children: [
            ...
            Theme.of(context).textTheme.bodyMedium?.copyWith(
                ...
                ),),Spacer(), Text(widget.cablePurchaseModel.data!.id!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Status',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text(widget.cablePurchaseModel.data!.status!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Phone',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text(widget.cablePurchaseModel.data!.phoneNumber!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Description',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text(widget.cablePurchaseModel.data!.detail!,style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Amount',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text('\u20A6${widget.cablePurchaseModel.data!.amount}',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Previous Balance',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text('\u20A6${widget.cablePurchaseModel.data!.oldBalance}',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('New Balance',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text('\u20A6${widget.cablePurchaseModel.data!.newBalance}',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),
          ],),
          ...
          SizedBox(height: sizeVertical * 1,),
           Row(children: [
            Text('Transaction Date',style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  // color: kBlack,
                  fontSize: SizeConfig.blockSizeVertical! * 1.8,
                ),),Spacer(), Text(widget.cablePurchaseModel.data!.dateAndTime!.substring(0, 10),

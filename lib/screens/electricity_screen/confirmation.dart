  ...
  Future<bool> _authenticateUser() async {
    ...
    if (canAuthenticate) {
      try {
        ...
        AppToast.error('User authentication Failed.');
        return false;
      }
    }
...
setState(() {
  ...
  void _onPinCompleted() {
    ...
    //   SnackBar(
    //     content: Text('Transaction Authorised successfully!'),
    //     duration: Duration(seconds: 2),
    ...
    setState(() {
      ...
      return;
        ...
        AppToast.error('Passcode does\'st match $securityPin');
        return;
      }
  }
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "${widget.validationModel!.message}",textAlign: TextAlign.right,
                        style: Theme.of(
                          context,
                        ).textTheme.headlineSmall?.copyWith(
                          fontSize: SizeConfig.blockSizeVertical! * 2.0,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "${widget.validationModel!.customerAddress}",textAlign: TextAlign.right,
                        style: Theme.of(
                          context,
                        ).textTheme.headlineSmall?.copyWith(
                          fontSize: SizeConfig.blockSizeVertical! * 2.0,

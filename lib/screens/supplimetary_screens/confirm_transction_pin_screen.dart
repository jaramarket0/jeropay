...
class ConfirmTransctionPinScreen extends StatefulWidget {
  const ConfirmTransctionPinScreen({super.key});

  @override
  State<ConfirmTransctionPinScreen> createState() => _ConfirmTransctionPinScreenState();
}

class _ConfirmTransctionPinScreenState extends State<ConfirmTransctionPinScreen> {
  ...
  void _onPinCompleted() {
    ...
    //   ),
    // );
myLog.log(controller.pin);
myLog.log(controller.cPin);

if (controller.pin != controller.cPin){
  ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('PIN Not The Same!'),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Please enter your 5 unique PIN you previously enter to confirm pin.',
